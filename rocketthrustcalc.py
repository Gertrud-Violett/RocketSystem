#====================================================
#Thrust calculator 2022 MIT License makkiblog.com
...
def ceathrust(Pci,ERi,MRi,Pambient,Ispeff,Thrust,At):
    ceares=CEA_Obj(
        oxName='LOX',
        fuelName='CH4',
        isp_units='sec',
