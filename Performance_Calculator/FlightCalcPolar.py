...
#VEHICLE Settings
etaS = [RSM['VEHICLE']['Stage1']['Structural_Efficiency'],RSM['VEHICLE']['Stage2']['Structural_Efficiency']] #Structural Efficiency 1st, 2nd stage
W0 = [RSM['VEHICLE']['Stage1']['Initial_Weight'],RSM['VEHICLE']['Stage2']['Initial_Weight']] #Full weight 1st, 2nd stage without payload
WPayload = RSM['VEHICLE']['Payload']['Weight'] #Payload weight
Wfuelrem = [RSM['VEHICLE']['Stage1']['Fuel_Remaining'],RSM['VEHICLE']['Stage2']['Fuel_Remaining']] #Fuel remaining for 1st, 2nd stage landing 
...
#ENGINE Settings
At=[RSM['ENGINE']['Stage1']['Throat_Dia']**2/4*np.pi, RSM['ENGINE']['Stage2']['Throat_Dia']**2/4*np.pi,0] #Throat dia in m2  [1st,2nd]
Ispeff=[RSM['ENGINE']['Stage1']['Isp_efficiency'], RSM['ENGINE']['Stage2']['Isp_efficiency'],1.0] #Isp efficiency
...
(t3,Wveh3,rad3,theta3,phi3,vr3,dthetat3,omega3,timearr3,Rocketarr3,attitudearr3,Wveharr3,Rarr3,velarr3,alt_arr3)=vehcalc(t2,Wveh,0,rad2,theta2,phi2,vr2,dthetat2,omega2,timearr2,Rocketarr2,attitudearr2,Wveharr2,Rarr2,velarr2,alt_arr2)
...
plot2=ax.plot_surface(xs, ys, zs, color='royalblue')
plot=ax.plot(X,Y,Z, color='red', linewidth='2')
axlimit=[-rad3*1.1e-3,rad3*1.1e-3]
ax.set_xlim(axlimit)
ax.set_ylim(axlimit)
ax.set_zlim(axlimit)
ax.view_init(45, 45) #Vert, Hor
plt.savefig('./plot/'+Case+'_Trajectory3D.jpg', dpi=300)
fig.show()
...
ax.set_ylim(axlimit)
ax.set_zlim(axlimit)
ax.view_init(90, 0) #Vert, Hor
plt.savefig('./plot/'+Case+'_Trajectory3D_90.jpg', dpi=300)
fig.show()
...
ax.set_ylim(axlimit)
ax.set_zlim(axlimit)
ax.view_init(0, 90) #Vert, Hor
plt.savefig('./plot/'+Case+'_Trajectory3D_0.jpg', dpi=300)
fig.show()
